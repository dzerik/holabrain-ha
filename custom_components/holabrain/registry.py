...
DISHWASHER = CategorySpec(
    ...
    sensors=(
        ...
        SensorSpec("brightenAgentTimes", "rinse_aid_refills",
                   ...
                   entity_registry_enabled_default=False),
        SensorSpec("totalwashTimes", "total_cycles", state_class=SensorStateClass.TOTAL_INCREASING,
                   capability="statistics", entity_category=EntityCategory.DIAGNOSTIC,
                   entity_registry_enabled_default=False),
        SensorSpec("totalWaterVol", "total_water", unit="L",
                   state_class=SensorStateClass.TOTAL_INCREASING, capability="statistics",
                   entity_category=EntityCategory.DIAGNOSTIC,
                   entity_registry_enabled_default=False),
        SensorSpec("totalElectricVol", "total_energy", unit="Wh",
                   state_class=SensorStateClass.TOTAL_INCREASING, capability="statistics",
                   entity_category=EntityCategory.DIAGNOSTIC,
                   entity_registry_enabled_default=False),
    ),
